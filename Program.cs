...
namespace Founders
{
    class Program
    {
        ...
        static public int DisplayMenu()
        {
            ...
            //Console.WriteLine("Give your TA to people who want to send you EOS Stealth via Trusted Transfer");
            //Console.WriteLine();
  ...
  "Displays RAIDA statistics of all networks", CommandOptionType.NoValue);
    ...
    CommandOptionType.SingleValue);
            ...
            CommandOption folders = commandLineApplication.Option(
              "-$|-f |--folders ",
              "The command to display EOS Stealth Working Folder Structure",
                CommandOptionType.NoValue);

            CommandOption pown = commandLineApplication.Option(
              "-$|-p |--pown ",
              "The command to pown/detect/import your EOS Stealth.",
                CommandOptionType.NoValue);
  ...
  "-$|-ex |--export ",
  "The command to export your EOS Stealth.",
    CommandOptionType.NoValue);
        ...
        public static void Backup(string TargetLocation)
        {
            if (Directory.Exists(TargetLocation))
            {
                ...
                string FileName = TargetLocation + Path.DirectorySeparatorChar + "EOS StealthBackup-t" + DateTime.Now.ToString("yyyyMMddhhmmss").ToLower();
                FS.WriteCoinsToFile(bankCoins, FileName, ".stack");
                updateLog("EOS Stealth Backed up to " + FileName);
                Console.WriteLine("EOS Stealth Backup successful");
            }
            else
            {
        ...
        public static void printWelcome()
        {
            ...
            Console.ForegroundColor = ConsoleColor.White;
            updateLog("                                                                  ");
            updateLog("                   EOS Stealth Console Edition                    ");
            updateLog(String.Format("               Version Console-{0}-2.0.1.7                ", DateTime.Now.ToString("dd-MMM-yyyy")));
            updateLog("         Used to Authenticate, Store, and Payout EOS Stealth      ");
        ...
        public static void ExportCoins()
        {
            ...
            Console.Out.WriteLine("Do you want to export your EOS Stealth to (1)jpgs, (2) stack (JSON), (3) QR Code,");
            ...
            if (onesTotalCount > 0)
            {
                ...
                Console.Out.WriteLine("Exporting "+ (exp_1) + " EOS Stealth");
            ...
            if (fivesTotalCount > 0)
            {
                ...
                Console.Out.WriteLine("Exporting " + (exp_1 + (exp_5 * 5)) + " EOS Stealth");
            ...
            if ((qtrTotalCount > 0))
            {
                ...
                Console.Out.WriteLine("Exporting " + (exp_1 + (exp_5 * 5) + (exp_25 * 25)) + " EOS Stealth");
            ...
            if (hundredsTotalCount > 0)
            {
                ...
                Console.Out.WriteLine("Exporting " + (exp_1 + (exp_5 * 5) + (exp_25 * 25) + (exp_100 * 100)) + " EOS Stealth");
            ...
            if (twoFiftiesTotalCount > 0)
            {
                ...
                Console.Out.WriteLine("Exporting " + (exp_1 + (exp_5 * 5) + (exp_25 * 25) + (exp_100 * 100) + (exp_250 * 250)) + " EOS Stealth");
            ...
            printStarLine();
            updateLog("Starting EOS Stealth Export.");
            updateLog("Please do not close the EOS Stealth Console program until it is finished.");
            updateLog("Otherwise it may result in loss of EOS Stealth.");
            printStarLine();
            string message = "Exporting "+ totalSaved +" EOS Stealth from Bank.";
            updateLog(message);
            printStarLine();
            ...
            if (file_type == 1)
            {
                String filename = (FS.ExportFolder  + totalSaved + ".EOS Stealth." + tag + "");
                while (File.Exists(filename+".jpg"))
                {
                    ...
                    existingFilename++;
                    filename = (FS.ExportFolder  + totalSaved + ".EOS Stealth." + tag + "."+ existingFilename + "");
                }//end if file exists
                ...
                foreach (var coin in exportCoins)
                {
                    ...
                    if (fileGenerated)
                    {
                        updateLog("EOS Stealth exported as Jpeg to " + OutputFile);
                        //Console.WriteLine("EOS Stealth exported as Jpeg to " + OutputFile);
                    }
                }
    ...
    CultureInfo.InvariantCulture);
                        ...
                        //Console.WriteLine("EOS Stealth exported as Stack to " + OutputFile);
                        updateLog("EOS Stealth exported as Stack to " + OutputFile);
                    }
                    try
                    {
                        FS.RemoveCoins(exportCoins, FS.BankFolder);
...
CultureInfo.InvariantCulture);
                    ...
                    if (fileGenerated)
                    {
                        updateLog("EOS Stealth Exported as QR code to " + OutputFile);
                        //Console.WriteLine("EOS Stealth Exported as QR code to " + OutputFile);
                    }
                }
...
CultureInfo.InvariantCulture);
                    ...
                    if (fileGenerated)
                    {
                        updateLog("EOS Stealth Exported as Bar code to " + OutputFile);
                        //Console.WriteLine("EOS Stealth Exported as Bar code to " + OutputFile);
                    }
                }
            ...
            if (file_type == 5)
            {
                String filename = (FS.ExportFolder  + totalSaved + ".EOS Stealth." + tag + ".csv");
                while (File.Exists(filename))
                {
                    ...
                    //int tagrand = rnd.Next(999);
                    existingFilename++;
                    filename = (FS.ExportFolder + totalSaved + ".EOS Stealth." + tag + "." + existingFilename + ".csv");
            ...
            printStarLine();
            updateLog("Export of the EOS Stealth Completed.");
        ...
        public static void export()
        {
            ...
            Console.Out.WriteLine("Do you want to export your EOS Stealth to (1)jpgs, (2) stack (JSON),");
            ...
            Console.Out.WriteLine("  Exporting EOS Stealth Completed.");
        }// end export One
         /* STATIC METHODS */
        ...
        static async Task SendCoinsTT()
        {
            ...
            Console.Out.WriteLine("How Many EOS Stealth are you Sending?");
            ...
            string path = FS.ExportFolder  + total + ".EOS Stealth.TrustedTrade.stack";
        ...
        static bool OnStatusChange()
        {
            ...
            {
                var filenames = new DirectoryInfo(FS.ExportFolder).GetFiles("*.EOS Stealth.TrustedTrade.stack");
        ...
        static async void DownloadCoin(string hash)
        {
            using (System.Net.Http.HttpClient cli = new System.Net.Http.HttpClient())
            {
                ...
                File.WriteAllText(FS.ImportFolder + Path.DirectorySeparatorChar + "EOS Stealth.FromTrustedTrade.stack", ccstack);
